...
\begin{itemize}
  \item \textbf{Family A: simple projector into the LLM embedding space.} (Simplest and most common) 
  ...
  This is essentially the spirit of \textbf{LLaVA}: connect a pretrained vision encoder and an LLM with a trainable projection layer, then instruction-tune the whole multimodal system on image-text instruction data.
